 ...
 */
public interface Lkj18Service {

    /**
     * 生成待审批的lkjDataLine
     */
    List<Lkj18> createLkjDataLine(DataApproveFlow dataApproveFlow, List<Lkj18> rawLkjDataLines);
     ...
     * 更新版本后，对数据打上版本信息
     */
    void setVersionData(DataVersion dataVersion, List<Lkj18> lkjDataLines);
}
